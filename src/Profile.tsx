...
const ProfilePage: React.FC = () => {
  ...
  const fetchRaceHistory = async (page: number) => {
    ...
    try {
      ...
      setRaceHistory(prevRaces => {
        const existingRaceIds = new Set(prevRaces.map(race => race.id));
        
        const newRaces = races.filter((race:RaceRecord) => !existingRaceIds.has(race.id));
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-3 gap-4">
            ...
            <div className="bg-gray-900 rounded-lg p-4 text-center">
              ...
              <div className="text-xl font-semibold">{race.accuracy.toFixed(1)}%</div>
    ...
    <div className="relative min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-900 text-white flex flex-col items-center p-4 overflow-hidden">
      <div className="relative z-10 max-w-5xl w-full space-y-12">
        ...
        {loading ? (
          ...
          <div>
            <ProfileGraph races={raceHistory} />
              ...
              {raceHistory.map((race) => (
                ...
                >
                  <div className="flex justify-between items-center mb-4">
                    <div className="text-cyan-400 font-semibold">{formatDate(race.date)}</div>
